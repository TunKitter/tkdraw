...
export default function createYoutubeFrameSkeletonAndPropertyFlow() {
  ...
  Toolbar.getInstance()
    ...
    .addEventListener('click', function (toobar_btn) {
      ...
      function finishCreatingShape(e: SelectoEvents['selectEnd']) {
        ...
        const url = prompt('Enter a Youtube URL:') as string;
        ...
        div.innerHTML = `<iframe width="100%" height="100%" src="https://www.youtube.com/embed/${youtubeId}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`
